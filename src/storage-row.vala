            ...
            if(check_button != null)
            {
                check_button.toggled.connect(() => {
                    if(check_button.get_active())
                        ((StorageView) (GLib.Application.get_default() as Application).get_window().get_views()[Views_list.STORAGE]).get_storage_list_box().select_row(this);
                    else
                        ((StorageView) (GLib.Application.get_default() as Application).get_window().get_views()[Views_list.STORAGE]).get_storage_list_box().unselect_row(this);
                });
