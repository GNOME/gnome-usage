    ...
    public class StorageActionBar : Gtk.ActionBar
    {
        ...
        private void delete_clicked()
        {
            ...
            if(number_of_files == 1)
            {
                ...
                display_message = "Are you sure you want to permanently delete \"" + filename + "\" ?";
            }
            else
                display_message = _(ngettext ("Are you sure you want to permanently delete the %d selected items?", "Are you sure you want to permanently delete the %d selected items?", (int)number_of_files)).printf((int)number_of_files);
